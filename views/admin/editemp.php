...
<html>
    ...
    <body>
        ...
        <table class="data-table">
            <caption class="title">customer</caption>
            <thead>
                <tr>
                    <th>ID</th>
                    <th>NAME</th>
            ...
            <tbody>
                ...
                foreach ($arrData as $arr) {
                    ...
                    <tr>
                        ...
                        <td> <?php echo $arr['e_name']; ?></td>
                        <td> <?php echo $arr['password']; ?></td>
                        <td> <?php echo $arr['e_email']; ?></td>
                        <td> <?php echo $arr['e_address']; ?></td>
                        <td> <?php echo $arr['e_phone']; ?></td>
                        <td> <?php echo $arr['account_permission']; ?></td>
